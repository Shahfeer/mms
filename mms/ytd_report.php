...
site_log_generate("YTD Report Page : User : ".$_SESSION['yjtmms_user_name']." access the page on ".date("Y-m-d H:i:s"));

$thismonth_startdate 	= date("Y-01-01");
...
//sent api response
$curl = curl_init();
$api_url='http://localhost:10017/report/ytd_report';
...
$data = json_decode($response, true); //store response in $data variable
...
/*if (!isset($data['response_code']) || $data['response_code'] != 1 || !isset($data['ytd_result']) || !is_array($data['ytd_result'])) {
	{ ?>
...
if (isset($data['ytd_result']) && is_array($data['ytd_result'])) {
	foreach ($data['ytd_result'] as $report) {
	...
	// Initialize empty arrays if 'ytd_result' is not set or is not an array
	$entry_date_array = [];
	$visitor_cnt_array = [];
	$male_cnt_array = [];
	$female_cnt_array = [];
...
<head>
	...
	<title>YTD Report : <?=$site_title?></title>
			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span> YTD Report</h4>
									...
									<div class="card-body">
										<form action="#" method="post" class="j-pro" id="j-pro" novalidate=""
											...
											<div class="table-responsive dt-responsive">
												...
												<div class="container">
													<div style="text-align: center; font-size: 1.4rem; font-weight: bold;">YTD Report Duration : <?=$thismonth_startdate?> - <?=$thismonth_yesterday?></div>
