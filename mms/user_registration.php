...
if($_GET['process'] == 'dir')
{
  $_SESSION['yjtsms_direct_access'] = 1; ?>
  <script>window.location="user_registration";</script>
<?php exit();
}
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
        <? 
        if($_SESSION['yjtsms_direct_access'] == 1) {
          include("libraries/site_menu1.php"); 
        } else { 
 ...
 <!-- WEBCAM-->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="hidden" name="imageid" id="imageid" class="image-tag" >
            ...
            <!-- <div class="col-md-12 text-center">
                          ...
                          <div class="mb-4 col-lg-6 offset-lg-3">
                            <div class="row">
                              ...
                              <div class="mb-9 col-md-9">
                                <input class="form-control" type="text" id="txt_user_name" name="txt_user_name" value="" placeholder="Name" title="Name" autofocus tabindex="1" onkeypress="return clsAlphaNoOnly(event)" pattern="[a-zA-Z0-9 -_]+" required />
                            ...
                            <div class="row">
                              ...
                              <div class="mb-9 col-md-9">
                                ...
                                <input class="form-control" type="text" id="txt_user_mobile" name="txt_user_mobile"  onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"
                ...
                <input type="hidden" class="form-control" name='otp_call_function' id='otp_call_function'
																	value='' />
                                <input class="form-control" maxlength="6" type="text" id="txt_user_otp" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"name="txt_user_otp" tabindex="3" value=""  onblur="return otp_validate_mobileno()" placeholder="OTP" title="OTP" required />
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="mb-9 col-md-9">
                                ...
                                <input class="form-control" type="email" id="txt_user_email" name="txt_user_email" value="" placeholder="Email Id" data-placement="top" tabindex="4" title="Email" required />
...
<?php
        $sql_query = "SELECT visitor_interest_title, visitor_interest_id FROM `interest_list` where visitor_interest_status = 'Y' ORDER BY visitor_interest_title Asc";
  ...
  <!-- </div>
                                  ...
                                  <!-- </div>  -->
                                         <div class="row"  style='font-family: "FiraSansExtraCondensed", sans-serif !important; margin-bottom: 0.5rem; font-size: 0.90rem; font-weight: 500; color: #566a7f;'>
                              <!-- <div class="mb-3 col-md-3"> -->
                          ...
                          <!-- </div> -->
                            ...
                            <div class="row">
																<input type="hidden" class="form-control" name='call_function_main' id='call_function_main'
																	value='register' />
																<input type="hidden" class="form-control" name='hid_sendurl' id='hid_sendurl'
																	value='<?=$server_http_referer?>' />
                                  </div>
                        <div class="mt-2 right_align">
                          <button type="submit" id="submit"  name="submit" tabindex="6" class="btn btn-primary me-2">Submit</button>
...
$('#submit').click(function() {
  $('.main').each(function() {
    if ($(this).find(':checkbox:checked').length == 0){
			// $("#id_error_display_submit").html("Check Box Was Not Selected!");
 ...
 <script>
   ...
   if (email === '') {
      ...
      var isValid = rea.test(email);
      if (!isValid) {
        $('#txt_user_email').css('border-color', 'red');
        console.log("Invalid email format");
        flag = false;
      } else {
        $('#txt_user_email').css('border-color', ''); // Reset border color if valid
