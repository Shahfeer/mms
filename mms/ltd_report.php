...
$api_url='http://localhost:10017/report/ltd_report';
...
curl_setopt_array($curl, array(
	...
	// CURLOPT_POSTFIELDS => http_build_query(array('date' => $date)), // Adjust this based on your API requirements
...
// Assuming $data['data']['report'] contains your API response
if (isset($data['data']['report']) && is_array($data['data']['report'])) {
    foreach ($data['data']['report'] as $report) {
...
<body>
	...
	<!-- Add chart packages for showing lines -->
	<!-- <script src="https://unpkg.com/chart.js"></script>  -->
	<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.7.2/chart.min.js"></script> -->
