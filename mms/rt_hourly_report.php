...
site_log_generate("Real Time Hourly Report Page : User : ".$_SESSION['yjtmms_user_name']." access the page on ".date("Y-m-d H:i:s"));
?>
<!DOCTYPE html>
...
<meta http-equiv="refresh" content="120">  
  <meta http-equiv="refresh" content="120">
	...
	<title>Today Hourly Report : <?=$site_title?></title>
	...
	<link href="assets/css/gallery_2.css" rel="stylesheet"/>
</head>
...
<body>
			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span> Today Report </h4>
									...
									<div class="card-body">
										<form action="#" method="post" class="j-pro" id="j-pro" novalidate=""
											...
											<div class="table-responsive dt-responsive">
												...
												<div class="container">
													<table id="rthr-grid" class="table table-striped table-bordered" style="width:100%; text-align: center;">
														<thead>
															<tr>
																<th>#</th>
																<th>Store Name</th>
																...
																<th>Face ID</th>
																<th>Gender</th>
																<th style='width: 40px !important;'>Age</th>
																<th>Age Category</th>
																<th>Entry Date</th>
															</tr>
														</thead>
	...
	<script type="text/javascript" src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap.min.js"></script>
        ...
        <script src="assets/js/gallery_2.js"></script>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function() {
            var dataTable = $('#rthr-grid').DataTable({
                "responsive": true,
                "searching": true,
                "processing": true,
                "serverSide": true,
                ...
                "columns": [
                    ...
                    { 
                        ...
                        "render": function (data, type, row) {
                            return row.camera_position + " - " + row.ip_address + "<br>" + row.camera_details;
                        }
                    },
                    { 
                        "data": null,
                        "render": function (data, type, row) {
                            var customerName = row.customer_name ? row.customer_name : '-- NO --';
                            var imgSrc = row.img_path ? row.img_path : 'https://yjtec.in/sms_portal/libraries/assets/images/people.png';
                            return "<a href='" + imgSrc + "' data-lightbox='mygallery_" + row.id + "'><img src='" + imgSrc + "' style='width: 100px; height: auto; max-height: 100px;'></a><br>" + customerName;
                        }
                    },
