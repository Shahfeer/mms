...
site_log_generate("User List Page : User : ".$_SESSION['yjtmms_user_name']." access the page on ".date("Y-m-d H:i:s"));
?>
<!DOCTYPE html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Customer List : <?=$site_title?></title>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/buttons/1.6.2/css/buttons.dataTables.css">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home /</span> Customer List</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
											<form action="#" method="post" class="j-pro" id="j-pro" novalidate="" style="border:0px !important;">
                        <!-- Responsive Table -->
...
$(document).ready(function () {
    var dataTable = $('#employee-grid').DataTable({
        ...
        "ajax": {
            ...
            data: {action: 'getEMP'}, // Set the POST variable array and add action: getEMP
            dataSrc: function (json) {
                // Ensure this matches the structure of your JSON response
                // alert(json.recordsFiltered);
                if (json.logout) {
        //     // alert(""); // Show your alert message if needed
            window.location = "index"; // Redirect to the index page
