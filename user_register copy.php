                            ...
                            <div class="mb-9 col-md-9">
                              ...
                              if ($response_data && isset($response_data['data']['report'])) {
                                ...
                                foreach ($response_data['data']['report'] as $key => $interest) {
                                  ...
                                  echo '<input type="checkbox" class="interestCheckbox" name="interests[]" value="' . htmlspecialchars($interest['visitor_interest_id']) . '" style="margin-right: 5px;">'; // Checkbox value is set to visitor_id
