...
async function mtdReport(req) {
    try {
        ...
        // Calculate difference in days between current month start date and yesterday's date
        const differenceInDays = Math.floor((yesterday - currentMonthStartDate) / (1000 * 60 * 60 * 24));
